...
/**
 * Arjuna Sarthi Circular Emblem.
 *
 * Design guidelines:
 * - 100% Circular geometry.
 * - Color scheme strictly matches the application palette:
 *   Refined warm bronze (#B5906A / #8C6D4F), deep espresso slate (#231E19 / #1A1613),
 *   sandstone parchment (#E3D7C8 / #F2EDE5), and muted steel info (#728A9E).
 * - NO yellow, NO purple.
 * - Refined, elegant proportions with 4 floating orbital rings.
 */
export function ArjunaSarthiLogo({
  size = "md",
  className = "",
  animate = true,
}: ArjunaSarthiLogoProps) {
  // Dimension mapping: refined, never overly huge
  const dim =
    size === "sm" ? 32 : size === "md" ? 48 : size === "lg" ? 80 : 140;
  ...
  return (
    ...
    >
      ...
      >
        <defs>
          {/* Primary bronze palette matching --color-primary (#B5906A / #785A3C) */}
          <linearGradient id="arjunaBronze" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#D9C2AA" />
            <stop offset="50%" stopColor="#B5906A" />
            <stop offset="100%" stopColor="#785A3C" />
          </linearGradient>

          {/* Secondary sandstone / steel palette matching --color-info / border */}
          <linearGradient id="arjunaSteel" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#9AB0C2" />
            <stop offset="100%" stopColor="#556D7F" />
          </linearGradient>

          {/* Deep espresso dark backdrop matching --color-surface (#231E19) */}
          <radialGradient id="arjunaCoreBg" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#2D2620" />
            <stop offset="70%" stopColor="#231E19" />
            <stop offset="100%" stopColor="#1A1613" />
          </radialGradient>

          <radialGradient id="arjunaGlow" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#B5906A" stopOpacity="0.25" />
            <stop offset="60%" stopColor="#785A3C" stopOpacity="0.1" />
        ...
        <circle
          ...
          cy="80"
          r="76"
          fill="url(#arjunaCoreBg)"
          stroke="#3D332A"
          strokeWidth="1.5"
        />

        {/* Subtle Ambient Radial Glow */}
        <circle cx="80" cy="80" r="68" fill="url(#arjunaGlow)" />
        ...
        {/* Layer 3: Middle-Outer Orbit (Muted Sandstone Bronze) */}
        <g
        ...
        {/* Layer 2: Middle-Inner Orbit (Refined Steel Slate) */}
        <g
        ...
        {/* Left Leg of A (Gandiva Bow Curve) */}
        <path
          d="M80 34 L42 120"
          stroke="url(#arjunaBronze)"
          strokeWidth="11"
        ...
        {/* Sudarshana Knowledge Crossbar (Matching Steel / Slate) */}
        <line
          x1="57"
          y1="90"
          x2="103"
          y2="90"
          stroke="url(#arjunaSteel)"
          strokeWidth="7"
          strokeLinecap="round"
        />
